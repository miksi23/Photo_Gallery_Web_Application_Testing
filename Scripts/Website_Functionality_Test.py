...
class WebsiteFunctionalityTest:
    def __init__(self, browser_type):
        ...
        self.screenshot_path = os.path.abspath(r"C:\Users\User\Desktop\New folder\screenshot.png")
        self.cover_photo_path = os.path.abspath(r"C:\Users\User\Desktop\New folder\cat-ga2192b34a_12801234511.jpg")
        self.new_cover_photo_path = os.path.abspath(r"C:\Users\User\Desktop\New folder\seashells-g10fcd89cc_12801234523456.jpg")
        self.image1_path = os.path.abspath(r"C:\Users\User\Desktop\New folder\igu-dfhadgg63ec0bd99_1280.jpg")
        self.image2_path = os.path.abspath(r"C:\Users\User\Desktop\New folder\marguerite-gc981fd054_128011.jpg")
    ...
    @staticmethod
    def wait_for_seconds(seconds=3):
        """
        a helper function that creates a pause in code execution for a specified number of seconds
    
        arguments:
        seconds (int or float, optional): the time of the pause in seconds, default number of seconds to wait is 3 second/s
        """
        time.sleep(seconds)
    ...
    def run_test(self):      
        ...
        try:
            ...
            # new album creation
            self.create_album("my first album, second attempt", "describing my first album, second attempt")
            ...
            delete_image_button=self.browser.find_element(By.XPATH, "/html/body/app/master-layout/div/main/div/loader-component/div/baasic-photo-list-route/baasic-album-detail/div/div[2]/div[1]/span/div[1]/div[3]/div/button")
            self.hover_and_click(delete_image_button)
            confirm_delete=self.browser.find_element(By.XPATH, "//button[@class='btn btn--med btn--warning']") # refreshing the reference to latest_album_thumbnail
            confirm_delete.click()
